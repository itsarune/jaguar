...
void initialize() {
  ...
  pidSet(&driveStraightRight, 0.221, 0.01675, 0.48, rightMotor1);
  pidSet(&driveTurnRight, 0.3, 0, 0, rightMotor1);
  pidSet(&driveTurnLeft, 0.3, 0, 0, leftMotor1);
  pidSet(&driveStraightLeft, 0.95, 0.000001, 0.27, leftMotor1);
}
